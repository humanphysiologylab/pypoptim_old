...
/*
    ...
    STATES, CONSTANTS and ALGEBRAIC are described in the csv files.
    Andrey Pikunov
*/

 void initialize_states_default(double *STATES) {
     STATES[0]	= -74.031982;	//  V
     STATES[1]	= 130.022096;	//  Na_c
     STATES[2]	= 8.516766;	//  Na_i
     STATES[3]	= 0.003289;	//  m
     STATES[4]	= 0.877202;	//  h1
     STATES[5]	= 0.873881;	//  h2
     STATES[6]	= 0.000071;	//  Ca_d
     STATES[7]	= 0.000014;	//  d_L
     STATES[8]	= 0.998597;	//  f_L1
     STATES[9]	= 0.998586;	//  f_L2
     STATES[10]	= 5.560224;	//  K_c
     STATES[11]	= 129.485991;	//  K_i
     STATES[12]	= 0.001089;	//  r
     STATES[13]	= 0.948597;	//  s
     STATES[14]	= 0.000367;	//  a_ur
     STATES[15]	= 0.967290;	//  i_ur
     STATES[16]	= 0.004374;	//  n
     STATES[17]	= 0.000053;	//  pa
     STATES[18]	= 1.815768;	//  Ca_c
     STATES[19]	= 0.000065;	//  Ca_i
     STATES[20]	= 0.026766;	//  O_C
     STATES[21]	= 0.012922;	//  O_TC
     STATES[22]	= 0.190369;	//  O_TMgC
     STATES[23]	= 0.714463;	//  O_TMgMg
     STATES[24]	= 1.382220;	//  O
     STATES[25]	= 0.632613;	//  Ca_rel
     STATES[26]	= 0.649195;	//  Ca_up
     STATES[27]	= 0.431547;	//  O_Calse
     STATES[28]	= 0.470055;	//  F1
     STATES[29]	= 0.002814;	//  F2
 ...
 void initialize_constants_default(double *CONSTANTS) {
     CONSTANTS[0]	= 8314.000000;	//  R
     CONSTANTS[1]	= 306.150000;	//  T
     CONSTANTS[2]	= 96487.000000;	//  F
     CONSTANTS[3]	= 50.000000;	//  Cm
     CONSTANTS[4]	= 0.000000;	//  stim_offset
     CONSTANTS[5]	= 1.000000;	//  stim_period
     CONSTANTS[6]	= 0.006000;	//  stim_duration
     CONSTANTS[7]	= -15.000000;	//  stim_amplitude
     CONSTANTS[8]	= 0.001800;	//  P_Na
     CONSTANTS[9]	= 6.750000;	//  g_Ca_L
     CONSTANTS[10]	= 60.000000;	//  E_Ca_app
     CONSTANTS[11]	= 0.025000;	//  k_Ca
     CONSTANTS[12]	= 8.250000;	//  g_t
     CONSTANTS[13]	= 2.250000;	//  g_kur
     CONSTANTS[14]	= 3.100000;	//  g_K1
     CONSTANTS[15]	= 1.000000;	//  g_Ks
     CONSTANTS[16]	= 0.500000;	//  g_Kr
     CONSTANTS[17]	= 0.060599;	//  g_B_Na
     CONSTANTS[18]	= 0.078681;	//  g_B_Ca
     CONSTANTS[19]	= 1.000000;	//  K_NaK_K
     CONSTANTS[20]	= 68.550000;	//  i_NaK_max
     CONSTANTS[21]	= 36.482900;	//  pow_K_NaK_Na_15
     CONSTANTS[22]	= 4.000000;	//  i_CaP_max
     CONSTANTS[23]	= 0.000200;	//  k_CaP
     CONSTANTS[24]	= 0.037484;	//  K_NaCa
     CONSTANTS[25]	= 0.000300;	//  d_NaCa
     CONSTANTS[26]	= 0.450000;	//  gamma_Na
     CONSTANTS[27]	= 0.000000;	//  ACh
     CONSTANTS[28]	= 0.000000;	//  phi_Na_en
     CONSTANTS[29]	= 0.005884;	//  Vol_i
     CONSTANTS[30]	= 0.000118;	//  Vol_d
     CONSTANTS[31]	= 0.010000;	//  tau_di
     CONSTANTS[32]	= 2.500000;	//  Mg_i
     CONSTANTS[33]	= 0.000800;	//  Vol_c
     CONSTANTS[34]	= 14.300000;	//  tau_Na
     CONSTANTS[35]	= 10.000000;	//  tau_K
     CONSTANTS[36]	= 24.700000;	//  tau_Ca
     CONSTANTS[37]	= 130.000000;	//  Na_b
     CONSTANTS[38]	= 1.800000;	//  Ca_b
     CONSTANTS[39]	= 5.400000;	//  K_b
     CONSTANTS[40]	= 2800.000000;	//  I_up_max
     CONSTANTS[41]	= 0.000300;	//  k_cyca
     CONSTANTS[42]	= 0.500000;	//  k_srca
     CONSTANTS[43]	= 0.400000;	//  k_xcs
     CONSTANTS[44]	= 200000.000000;	//  alpha_rel
     CONSTANTS[45]	= 0.000397;	//  Vol_up
     CONSTANTS[46]	= 0.000044;	//  Vol_rel
     CONSTANTS[47]	= 0.815000;	//  r_recov
     CONSTANTS[48]	= 0.010000;	//  tau_tr
     CONSTANTS[49]	= 0.000300;	//  k_rel_i
     CONSTANTS[50]	= 0.003000;	//  k_rel_d

     CONSTANTS[51]  = 5e-5; // pca_tor
 }
...
ALGEBRAIC[39] = STATES[6]/(STATES[6]+CONSTANTS[11]);
    ...
    ALGEBRAIC[70] = calculate_ical_tor(CONSTANTS, RATES, STATES, ALGEBRAIC);
...
RATES[18] = (CONSTANTS[38] - STATES[18])/CONSTANTS[36]+((ALGEBRAIC[41]+ALGEBRAIC[70]+ALGEBRAIC[52]+ALGEBRAIC[55]) -  2.00000*ALGEBRAIC[56])/( 2.00000*CONSTANTS[33]*CONSTANTS[2]);
...
RATES[6] = - (ALGEBRAIC[41]+ALGEBRAIC[70]+ALGEBRAIC[58])/( 2.00000*CONSTANTS[30]*CONSTANTS[2]);
...
ALGEBRAIC[59] = (ALGEBRAIC[37]+ALGEBRAIC[41]+ALGEBRAIC[70]+ALGEBRAIC[44]+ALGEBRAIC[45]+ALGEBRAIC[46]+ALGEBRAIC[49]+ALGEBRAIC[47]+ALGEBRAIC[50]+ALGEBRAIC[52]+ALGEBRAIC[54]+ALGEBRAIC[55]+ALGEBRAIC[56]+ALGEBRAIC[57])/CONSTANTS[3]+ALGEBRAIC[24];
