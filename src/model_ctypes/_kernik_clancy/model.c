...
//
void compute_rates_algebraic(const double t, double *STATES, double *CONSTANTS, double *ALGEBRAIC, double *RATES){

  const double *model_parameter_inputs = CONSTANTS;
  double *dY = RATES;
  const double *Y = STATES;
  double *algebraic = ALGEBRAIC;
