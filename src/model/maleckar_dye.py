...
legend_states = pd.DataFrame([
    ...
    {'name': 'Fluo-3', 'component': 'intracellular_Ca_buffering', 'units': 'millimolar'}])
...
legend_constants = pd.DataFrame([
    ...
    {'name': 'Fluo-3_tot', 'component': 'intracellular_Ca_buffering', 'units': 'millimolar'},
    {'name': 'Fluo-3_kon', 'component': 'intracellular_Ca_buffering', 'units': 'per_second'},
    {'name': 'Fluo-3_koff', 'component': 'intracellular_Ca_buffering', 'units': 'per_second_per_millimolar'}])
...
legend_algebraic = pd.DataFrame([
    ...
    {'name': 'J_Fluo-3', 'component': 'intracellular_Ca_buffering', 'units': 'millimolar_per_second'}])
...
def compute_rates_algebraic(t, S, C, R=None, A=None):
    ...
    R[19] = -((A[52]+A[55]+A[67])-(A[58]+A[66]+2.00000*A[56]))/(2.00000*C[29]*C[2])-1.00000*A[63] - A[70]
