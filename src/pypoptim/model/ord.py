...
legend_constants = pd.DataFrame(
    [
        ...
        {"name": "ko", "component": "extracellular", "units": "millimolar"},
        {
            ...
            "units": "joule_per_kilomole_kelvin",
        },
        ...
        {"name": "KmCaMK", "component": "CaMK", "units": "millimolar"},
        {
            "name": "aCaMK",
            "component": "CaMK",
            "units": "per_millimolar_per_millisecond",
        },
        ...
        {"name": "kmcsqn", "component": "intracellular_ions", "units": "millimolar"},
        {
            ...
            "units": "microF_per_centimeter_squared",
        },
        ...
        {"name": "upScale", "component": "SERCA", "units": "dimensionless"},
        {
            "name": "ffrt",
            "component": "membrane",
            "units": "coulomb_per_mole_millivolt",
        },
...
legend_algebraic = pd.DataFrame(
    [
        ...
        {"name": "allo_i", "component": "INaCa_i", "units": "dimensionless"},
        {
            "name": "JncxNa_i",
            "component": "INaCa_i",
            "units": "millimolar_per_millisecond",
        },
        {
            "name": "JncxCa_i",
            "component": "INaCa_i",
...
legend = dict(
    states=legend_states, constants=legend_constants, algebraic=legend_algebraic
)
...
def init_states_constants():
    ...
    C[161] = (
        C[105] * 1.20000 if C[0] == 1 else C[105] * 1.30000 if C[0] == 2 else C[105]
    )
    ...
    C[193] = C[114]
    C[194] = (
        C[118] * 1.10000 if C[0] == 1 else C[118] * 1.40000 if C[0] == 2 else C[118]
    )
    ...
    C[204] = (
        C[140] * 0.900000 if C[0] == 1 else C[140] * 0.700000 if C[0] == 2 else C[140]
    )
    return S, C
...
def compute_rates_algebraic(t, S, C, R=None, A=None):
    ...
    R[34] = (
        -(
            ...
            * np.exp(C[67] * S[0])
            * S[34]
            * np.exp(((C[102] - 20.0000) * np.log(C[68])) / 10.0000)
            - C[69]
            * np.exp(C[70] * S[0])
            * S[35]
            * np.exp(((C[102] - 20.0000) * np.log(C[71])) / 10.0000)
        )
        + C[78]
        * np.exp(C[79] * S[0])
        * S[36]
        * np.exp(((C[102] - 20.0000) * np.log(C[80])) / 10.0000)
    ) - C[87] * np.exp(C[88] * S[0]) * S[34] * np.exp(
        ((C[102] - 20.0000) * np.log(C[89])) / 10.0000
    )
    R[35] = (
        (
            (
            ...
            - (
                ...
                * np.exp(C[61] * S[0])
                * S[35]
                * np.exp(((C[102] - 20.0000) * np.log(C[62])) / 10.0000)
                - C[63]
                * np.exp(C[64] * S[0])
                * S[39]
                * np.exp(((C[102] - 20.0000) * np.log(C[65])) / 10.0000)
            )
        )
        + C[81]
        * np.exp(C[82] * S[0])
        * S[37]
        * np.exp(((C[102] - 20.0000) * np.log(C[83])) / 10.0000)
    ) - C[90] * np.exp(C[91] * S[0]) * S[35] * np.exp(
        ((C[102] - 20.0000) * np.log(C[92])) / 10.0000
    )
    R[36] = -(
        C[54]
        * np.exp(C[55] * S[0])
        * S[36]
        * np.exp(((C[102] - 20.0000) * np.log(C[56])) / 10.0000)
        - C[57]
        * np.exp(C[58] * S[0])
        * S[37]
        * np.exp(((C[102] - 20.0000) * np.log(C[59])) / 10.0000)
    ) - (
        C[78]
        * np.exp(C[79] * S[0])
        * S[36]
        ...
        * np.exp(C[88] * S[0])
        * S[34]
        * np.exp(((C[102] - 20.0000) * np.log(C[89])) / 10.0000)
    )
    R[37] = (
        (
            C[54]
        ...
        - (
            ...
            * np.exp(C[73] * S[0])
            * S[37]
            * np.exp(((C[102] - 20.0000) * np.log(C[74])) / 10.0000)
            - C[75]
            * np.exp(C[76] * S[0])
            * S[38]
            * np.exp(((C[102] - 20.0000) * np.log(C[77])) / 10.0000)
        )
    ) - (
        C[81]
        * np.exp(C[82] * S[0])
    ...
    R[38] = (
        ...
        - (
            ...
            * np.exp(C[85] * S[0])
            * S[38]
            * np.exp(((C[102] - 20.0000) * np.log(C[86])) / 10.0000)
            - C[93]
            * np.exp(C[94] * S[0])
            * S[39]
            * np.exp(((C[102] - 20.0000) * np.log(C[95])) / 10.0000)
        )
    ) - (
        (
            (C[96] * C[97] * np.exp(C[98] * np.log(S[43])))
            / (np.exp(C[98] * np.log(S[43])) + C[99])
        )
        * S[38]
        - C[97] * S[41]
    )
    ...
    R[40] = (
        ...
        + (C[100] / (1.00000 + np.exp(-(S[0] - C[101]) / 6.78900))) * S[42]
    ) - C[100] * S[40]
    R[41] = (
        (
            (
    ...
    A[13] = 1.00000 / (
        C[38] * np.exp((S[0] + C[36]) / C[37]) + C[39] * np.exp(-(S[0] + C[40]) / C[41])
    )
    R[10] = (A[1] - S[10]) / A[13]
    A[2] = 1.00000 / (1.00000 + np.exp(((S[0] + C[42]) - C[46]) / C[43]))
    A[14] = 1.00000 / (
        1.43200e-05 * np.exp(-((S[0] + 1.19600) - C[46]) / 6.28500)
        + 6.14900 * np.exp(((S[0] + 0.509600) - C[46]) / 20.2700)
    )
    R[11] = (A[2] - S[11]) / A[14]
    A[15] = 1.00000 / (
        0.00979400 * np.exp(-((S[0] + 17.9500) - C[46]) / 28.0500)
        + 0.334300 * np.exp(((S[0] + 5.73000) - C[46]) / 56.6600)
    )
    R[12] = (A[2] - S[12]) / A[15]
    A[5] = 1.00000 / (1.00000 + np.exp(-(S[0] - 14.3400) / 14.8200))
    A[17] = 1.05150 / (
        1.00000 / (1.20890 * (1.00000 + np.exp(-(S[0] - 18.4099) / 29.3814)))
        + 3.50000 / (1.00000 + np.exp((S[0] + 100.000) / 29.3814))
    )
    R[19] = (A[5] - S[19]) / A[17]
    A[7] = 1.00000 / (1.00000 + np.exp(-(S[0] + 3.94000) / 4.23000))
    A[21] = 0.600000 + 1.00000 / (
        np.exp(-0.0500000 * (S[0] + 6.00000)) + np.exp(0.0900000 * (S[0] + 14.0000))
    )
    R[25] = (A[7] - S[25]) / A[21]
    A[8] = 1.00000 / (1.00000 + np.exp((S[0] + 19.5800) / 3.69600))
    A[22] = 7.00000 + 1.00000 / (
        0.00450000 * np.exp(-(S[0] + 20.0000) / 10.0000)
        + 0.00450000 * np.exp((S[0] + 20.0000) / 10.0000)
    )
    R[26] = (A[8] - S[26]) / A[22]
    A[23] = 1000.00 + 1.00000 / (
        3.50000e-05 * np.exp(-(S[0] + 5.00000) / 4.00000)
        + 3.50000e-05 * np.exp((S[0] + 5.00000) / 6.00000)
    )
    R[27] = (A[8] - S[27]) / A[23]
    A[19] = A[8]
    ...
    A[25] = C[104] + 1.00000 / (
        0.000232600 * np.exp((S[0] + 48.2800) / 17.8000)
        + 0.00129200 * np.exp(-(S[0] + 210.000) / 230.000)
    )
    R[44] = (A[10] - S[44]) / A[25]
    A[11] = 1.00000 / (
        1.00000
        + np.exp(-(S[0] + 2.55380 * C[3] + 144.590) / (1.56920 * C[3] + 3.81150))
    )
    A[26] = 122.200 / (
        np.exp(-(S[0] + 127.200) / 20.3600) + np.exp((S[0] + 236.800) / 69.3300)
    )
    R[46] = (A[11] - S[46]) / A[26]
    A[36] = (C[20] * (1.00000 - S[1])) / (1.00000 + C[21] / S[2])
    R[1] = C[18] * A[36] * (A[36] + S[1]) - C[19] * S[1]
    A[16] = A[2]
    A[27] = 2.03800 + 1.00000 / (
        0.0213600 * np.exp(-((S[0] + 100.600) - C[46]) / 8.28100)
        + 0.305200 * np.exp(((S[0] + 0.994100) - C[46]) / 38.4500)
    )
    R[13] = (A[16] - S[13]) / A[27]
    A[31] = 1.00000 / (1.00000 + np.exp(-(S[0] - 24.3400) / 14.8200))
    R[22] = (A[31] - S[22]) / A[17]
    A[32] = 7.00000 + 1.00000 / (
        0.0400000 * np.exp(-(S[0] - 4.00000) / 7.00000)
        + 0.0400000 * np.exp((S[0] - 4.00000) / 7.00000)
    )
    R[28] = (A[19] - S[28]) / A[32]
    A[33] = 100.000 + 1.00000 / (
        0.000120000 * np.exp(-S[0] / 3.00000) + 0.000120000 * np.exp(S[0] / 7.00000)
    )
    R[29] = (A[19] - S[29]) / A[33]
    A[34] = 2.50000 * A[22]
    R[31] = (A[8] - S[31]) / A[34]
    A[24] = A[10]
    A[35] = 1.00000 / (
        0.0100000 * np.exp((S[0] - 50.0000) / 20.0000)
        + 0.0193000 * np.exp(-(S[0] + 66.5400) / 31.0000)
    )
    R[45] = (A[24] - S[45]) / A[35]
    ...
    A[18] = (
        1.00000 - 0.950000 / (1.00000 + np.exp((S[0] + 70.0000) / 5.00000))
        if C[0] == 1
        else 1
    )
    A[30] = 4.56200 + 1.00000 / (
        0.393300 * np.exp(-(S[0] + 100.000) / 100.000)
        + 0.0800400 * np.exp((S[0] + 50.0000) / 16.5900)
    )
    A[43] = A[30] * A[18]
    R[20] = (A[6] - S[20]) / A[43]
    A[40] = 23.6200 + 1.00000 / (
        0.00141600 * np.exp(-(S[0] + 96.5200) / 59.0500)
        + 1.78000e-08 * np.exp((S[0] + 114.100) / 8.07900)
    )
    A[45] = A[40] * A[18]
    R[21] = (A[6] - S[21]) / A[45]
    A[47] = 1.35400 + 0.000100000 / (
        np.exp((S[0] - 167.400) / 15.8900) + np.exp(-(S[0] - 12.2300) / 0.215400)
    )
    ...
    A[12] = S[0] * C[149]
    A[73] = (4.00000 * C[169] * (S[2] * np.exp(2.00000 * A[12]) - 0.341000 * C[2])) / C[
        174
    ]
    A[74] = C[174] * (S[0] - C[158])
    A[75] = (
        A[73] * (1.00000 - 0.500000 * A[74])
        if ((-1e-7 <= A[74]) and (A[74] <= 1e-7))
        else (A[73] * A[74]) / (np.exp(A[74]) - 1.00000)
    )
    A[42] = A[36] + S[1]
    A[82] = 1.00000 / (1.00000 + C[17] / A[42])
    A[83] = (1.00000 - A[82]) * C[156] * A[75] * S[25] * (
        A[67] * (1.00000 - S[33]) + S[30] * A[70] * S[33]
    ) + A[82] * C[171] * A[75] * S[25] * (
        A[71] * (1.00000 - S[33]) + S[30] * A[72] * S[33]
    )
    A[85] = (C[166] * -A[83]) / (
        1.00000 + 1.00000 * (np.power(1.50000 / S[8], 8.00000))
    )
    ...
    A[66] = (
        C[154]
        * (S[0] - A[53])
        * ((1.00000 - A[65]) * S[19] * A[63] + A[65] * S[22] * A[64])
    )
    A[90] = C[159] * (np.power(C[3] / 5.40000, 1.0 / 2)) * S[38] * (S[0] - A[53])
    A[54] = ((C[4] * C[5]) / C[6]) * np.log(
        (C[3] + C[33] * C[1]) / (S[5] + C[33] * S[3])
    )
    ...
    A[162] = C[128] * np.exp(
        ((1.00000 - C[129]) * S[0] * C[6]) / (3.00000 * C[4] * C[5])
    )
    A[166] = (C[123] * (np.power(C[3] / C[131], 2.00000))) / (
        (
            np.power(1.00000 + C[1] / A[162], 3.00000)
            + np.power(1.00000 + C[3] / C[131], 2.00000)
        )
        - 1.00000
    )
    ...
    A[164] = (C[119] * (np.power(S[3] / A[161], 3.00000))) / (
        (
            np.power(1.00000 + S[3] / A[161], 3.00000)
            + np.power(1.00000 + S[5] / C[130], 2.00000)
        )
        - 1.00000
    )
    A[165] = (C[122] * (np.power(C[1] / A[162], 3.00000))) / (
        (
            np.power(1.00000 + C[1] / A[162], 3.00000)
            + np.power(1.00000 + C[3] / C[131], 2.00000)
        )
    ...
    A[168] = (C[126] * (np.power(S[5] / C[130], 2.00000))) / (
        (
            np.power(1.00000 + S[3] / A[161], 3.00000)
            + np.power(1.00000 + S[5] / C[130], 2.00000)
        )
    ...
    A[0] = (
        ...
        if (
            (t >= C[12])
            and (t <= C[13])
            and (((t - C[12]) - np.floor((t - C[12]) / C[15]) * C[15]) <= C[16])
        )
        else 0
    )
    A[183] = (S[6] - S[5]) / 2.00000
    R[5] = (
        -((A[66] + A[90] + A[96] + A[98] + A[181] + A[0]) - 2.00000 * A[179])
        * C[32]
        * C[183]
    ) / (C[6] * C[184]) + (A[183] * C[187]) / C[184]
    A[79] = (0.750000 * C[169] * (S[6] * np.exp(A[12]) - C[3])) / C[176]
    A[80] = C[176] * (S[0] - C[158])
    A[81] = (
        A[79] * (1.00000 - 0.500000 * A[80])
        if ((-1e-7 <= A[80]) and (A[80] <= 1e-7))
        else (A[79] * A[80]) / (np.exp(A[80]) - 1.00000)
    )
    A[87] = (1.00000 - A[82]) * C[173] * A[81] * S[25] * (
        A[67] * (1.00000 - S[33]) + S[30] * A[70] * S[33]
    ) + A[82] * C[182] * A[81] * S[25] * (
        A[71] * (1.00000 - S[33]) + S[30] * A[72] * S[33]
    )
    ...
    A[58] = (
        C[45]
        * (S[0] - A[50])
        * (np.power(S[10], 3.00000))
        * ((1.00000 - A[57]) * A[55] * S[13] + A[57] * A[56] * S[15])
    )
    A[59] = 1.00000 / (1.00000 + C[17] / A[42])
    A[60] = (
        C[153] * (S[0] - A[50]) * S[16] * ((1.00000 - A[59]) * S[17] + A[59] * S[18])
    )
    ...
    A[128] = (3.00000 * (A[126] * A[117] - A[123] * A[118]) + A[125] * A[114]) - A[
        124
    ] * A[111]
    ...
    A[185] = (
        A[182] * (1.00000 - 0.500000 * A[184])
        if ((-1e-7 <= A[184]) and (A[184] <= 1e-7))
        else (A[182] * A[184]) / (np.exp(A[184]) - 1.00000)
    )
    A[187] = (S[4] - S[3]) / 2.00000
    R[3] = (
        -(A[58] + A[60] + 3.00000 * A[130] + 3.00000 * A[179] + A[185]) * C[183] * C[32]
    ) / (C[6] * C[184]) + (A[187] * C[187]) / C[184]
    A[76] = (0.750000 * C[169] * (S[4] * np.exp(A[12]) - C[1])) / C[175]
    A[77] = C[175] * (S[0] - C[158])
    A[78] = (
        A[76] * (1.00000 - 0.500000 * A[77])
        if ((-1.00000e-07 <= A[77]) and (A[77] <= 1.00000e-07))
        else (A[76] * A[77]) / (np.exp(A[77]) - 1.00000)
    )
    A[84] = (1.00000 - A[82]) * C[172] * A[78] * S[25] * (
        A[67] * (1.00000 - S[33]) + S[30] * A[70] * S[33]
    ) + A[82] * C[181] * A[78] * S[25] * (
        A[71] * (1.00000 - S[33]) + S[30] * A[72] * S[33]
    )
    ...
    A[158] = (3.00000 * (A[156] * A[147] - A[153] * A[148]) + A[155] * A[144]) - A[
        154
    ] * A[141]
    ...
    A[186] = (
        C[143] * 4.00000 * C[169] * (S[9] * np.exp(2.00000 * A[12]) - 0.341000 * C[2])
    ) / C[179]
    A[188] = C[179] * (S[0] - C[165])
    A[189] = (
        A[186] * (1.00000 - 0.500000 * A[188])
        if ((-1.00000e-07 <= A[188]) and (A[188] <= 1.00000e-07))
        else (A[186] * A[188]) / (np.exp(A[188]) - 1.00000)
    )
    R[0] = -(
        A[58]
        + A[60]
    ...
    A[46] = 1.00000 / (
        1.00000
        + (C[26] * C[27]) / (np.power(C[27] + S[2], 2.00000))
        + (C[28] * C[29]) / (np.power(C[29] + S[2], 2.00000))
    )
    R[2] = A[46] * (
        (
            (-(A[83] - 2.00000 * A[160]) * C[32] * C[183]) / (2.00000 * C[6] * C[187])
            + (A[193] * C[186]) / C[187]
        )
        - A[191]
    )
    A[194] = (C[168] * 0.00437500 * S[9]) / (S[9] + 0.000920000)
    A[195] = (C[168] * 2.75000 * 0.00437500 * S[9]) / (
        (S[9] + 0.000920000) - 0.000170000
    )
    ...
    A[44] = 1.00000 / (
        1.00000
        + (C[150] * C[23]) / (np.power(C[23] + S[9], 2.00000))
        + (C[24] * C[25]) / (np.power(C[25] + S[9], 2.00000))
    )
    R[9] = A[44] * (
        (
            (-((A[190] + A[189]) - 2.00000 * A[130]) * C[32] * C[183])
            / (2.00000 * C[6] * C[184])
            - (A[198] * C[185]) / C[184]
        )
        + (A[191] * C[187]) / C[184]
